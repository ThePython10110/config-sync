...
# Causes zash to append to history instead of overwriting it so if you start a new terminal, you have old session history
# shopt -s histappend
...
alias ls='ls -aFh --color=always --hyperlink=auto' # add colors and file type extensions
...
install_zshrc_support() {
	...
	case $dtype in
		...
		"suse")
			...
			;;
		"debian")
			sudo apt-get install multitail tree zoxide fzf
